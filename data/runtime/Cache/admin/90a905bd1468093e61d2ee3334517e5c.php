        ...
        <tbody>
            <tr>
                ...
                <div class="explain_col">
                    ...
                    <option value="0" <?php if($search["status"] == '0'): ?>selected="selected"<?php endif; ?>>处理中</option>
                    <option value="1" <?php if($search["status"] == '1'): ?>selected="selected"<?php endif; ?>>已完成</option>
                    </select>
    ...
    <table width="100%" cellspacing="0">
        ...
        <tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center"><?php if($val['status'] == '0'): ?>处理中<?php else: ?><span class="green">已完成</span><?php endif; ?></td>
                <td align="center"><?php echo ($val["remark"]); ?></td>
                <td align="center"><a href="<?php echo u('score_order/edit', array('id'=>$val['id'], 'menuid'=>$menuid));?>">处理</a> | <a href="javascript:void(0);" class="J_confirmurl" data-uri="<?php echo u('score_order/delete', array('id'=>$val['id']));?>" data-acttype="ajax" data-msg="<?php echo sprintf(L('confirm_delete_one'),$val['title']);?>"><?php echo L('delete');?></a></td>

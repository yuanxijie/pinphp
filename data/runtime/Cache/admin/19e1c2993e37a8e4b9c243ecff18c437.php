<?php if (!defined('THINK_PATH')) exit();?><div class="dialog_content">
	<form id="info_form" name="info_form" action="<?php echo u('album_cate/add');?>" method="post">
...
<script>
var check_name_url = "<?php echo U('album_cate/ajax_check_name');?>";
$(function(){
    ...
    var uploader = new qq.FileUploaderBasic({
        ...
        multiple: false,
        action: "<?php echo U('album_cate/ajax_upload_img');?>",
        inputName: 'img',

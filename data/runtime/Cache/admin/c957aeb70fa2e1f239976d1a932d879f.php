...
<div class="dialog_content">
	<form id="info_form" action="<?php echo u('article_cate/add');?>" method="post">
	<table width="100%" class="table_form">
		<tr> 
			<th width="120"><?php echo L('article_cate_parent');?> :</th>
			<td>
				<!--<select class="J_cate_select mr10" data-pid="0" data-uri="<?php echo U('article_cate/ajax_getchilds');?>" data-selected="<?php echo ($spid); ?>">-->
                <select name="test">
...
//	$('.J_cate_select').cate_select();
    ...
    var uploader = new qq.FileUploaderBasic({
        ...
        multiple: false,
        action: "<?php echo U('article_cate/ajax_upload_img');?>",
        inputName: 'img',

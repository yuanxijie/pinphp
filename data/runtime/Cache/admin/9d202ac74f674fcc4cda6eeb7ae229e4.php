...
<div class="dialog_content">
	<form id="info_form" name="info_form" action="<?php echo U('nav/add');?>" method="post">
    <table width="100%" class="table_form">
        ...
        <tr>
            ...
            <td>
                <label><input type="radio" name="type" class="radio_style" value="main" checked="checked">&nbsp;<?php echo L('nav_type_main');?>&nbsp;&nbsp;&nbsp;</label>
                <label><input type="radio" name="type" class="radio_style" value="bottom">&nbsp;<?php echo L('nav_type_bottom');?></label>
            </td>
        </tr>
        <tr>
            <th><?php echo L('nav_target');?> :</th>
            <td>
                <label><input type="radio" name="target" class="radio_style" value="1">&nbsp;<?php echo L('yes');?>&nbsp;&nbsp;&nbsp;</label>
                <label><input type="radio" name="target" class="radio_style" value="0" checked="checked">&nbsp;<?php echo L('no');?></label>
            </td>
        </tr>
        <tr>
            <th><?php echo L('enabled');?> :</th>
            <td>
                <label><input type="radio" name="enabled" class="radio_style" value="1" checked="checked">&nbsp;<?php echo L('open');?>&nbsp;&nbsp;&nbsp;</label>
                <label><input type="radio" name="enabled" class="radio_style" value="0">&nbsp;<?php echo L('close');?></label>
            </td>
        </tr>
    </table>
    </form>
